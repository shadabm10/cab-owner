...
import com.project.sketch.ugo.screen.HelpScreenActivity;
...
/**
 * Created by ANDROID on 11/01/2019.
 */

public class AdapterHelpHistory extends RecyclerView.Adapter<AdapterHelpHistory.HistoryHolder>  {

    private List<BookHisSingle> bookHisSingleList;
    Context context;

    public AdapterHelpHistory(Context context_, List<BookHisSingle> countryModel) {
