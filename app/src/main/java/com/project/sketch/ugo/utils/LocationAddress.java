                    ...
                    if (latitude != 0.0){
                        ...
                        if (addresses != null && addresses.size() > 0) {
                            ...
                            if (globalClass.KEY_of_travel.equals("pickup")){
                                globalClass.Pickup_City = addresses.get(0).getLocality();
                            }else if (globalClass.KEY_of_travel.equals("drop")){
                                globalClass.DropOff_City = addresses.get(0).getLocality();
                            }
                            ...
                            Log.d(Constants.TAG, strReturnedAddress.toString());
                        } else {
                            Log.w(Constants.TAG, "No Address returned!");
                        }
